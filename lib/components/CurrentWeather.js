...
const CurrentWeather = (props) => {
  console.log(props);
  const {currentHumidity, currentLocation, currentTemp_F, currentWeatherSummary, currentWindMPH, precipTodayIn, icon_url, currentDate, currentTime, icon, currentExplanation} = props.weather;
