...
const cloudLightningMoon = 
require('../assets/Cloud-Lightning-Moon.svg');            
...
export const iconCleaner = (day, condition) => {
  if (!day && condition) {
    if (condition.includes('Drizzle')) {
      ...
      return cloudSnowMoon;
    } else if (condition.includes('Ice')) {
      return cloudHailMoon;
    } else if (condition.includes('Hail')) {
      return cloudHailMoonAlt;
    } else if (condition === 'Fog') {
      return cloudFogAlt;
    } else if (condition.includes('Fog')) {
      return cloudFogMoon;
    } else if (condition.includes('Blowing')) {
      return cloudWindMoon;
    } else if (condition.includes('Drifting')) {
      return cloudWindMoon;
