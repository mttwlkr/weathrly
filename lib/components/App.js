        ...
        <div className="App">
          <div className="gradientDiv" style={this.state.background}>
            <Search 
              ...
              city={this.state.city}
            />
            <p className="invalidCityWarning">Please enter a valid city! (ex. Denver, CO) </p>
            {
              this.state.currentWeather &&           
              <CurrentWeather className="current" weather={this.state.currentWeather}/>
            }
          </div>
          
          {
            this.state.sevenHour && 
            <SevenHourForecast className="sevenHourForecast" weather={this.state.sevenHour}/>
          }
          
          {
            this.state.tenDay &&
            <TenDayForecast className="tenDayForecast" weather={this.state.tenDay}/>
          }
        </div>
      );
    } else {
